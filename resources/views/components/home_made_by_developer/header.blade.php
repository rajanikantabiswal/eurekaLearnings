                ...
                <div class="logo-image">
                    <a href="{{ route('home') }}">
                        <img src="{{ get_image(get_frontend_settings('dark_logo')) }}" alt="system logo"
                            class="object-fit-cover  header-dark-logo">
                        <img src="{{ get_image(get_frontend_settings('light_logo')) }}" alt="system logo"
                            class="object-fit-cover  header-light-logo d-none">
                    </a>
                </div>
            </div>
            <div class="col-auto">
                            ...
                            <a href="{{ route('cart') }}" class="me-2 me-md-4 position-relative" data-bs-toggle="tooltip"
                                ...
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    ...
                                    <path
                                        ...
                                        stroke="#000000" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"
                                        stroke-linejoin="round" />
                                    <path d="M9 8H21" stroke="#000000" stroke-width="1.5" stroke-miterlimit="10"
