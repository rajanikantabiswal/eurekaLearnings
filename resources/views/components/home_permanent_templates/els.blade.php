    ...
    <script>
        window.onload = function() {
            try {
                ...
                var tc = TagCanvas.tc['myCanvas'];
                if (tc) {
                    console.log('BeginStart called successfully!');
                }
            } catch (e) {
