...
@section('content')
                    ...
                    <div class="eNtry-breadcum">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">{{ get_phrase('All Certifications') }}</li>
                            </ol>
                        </nav>
                        <h3 class="g-title">{{ get_phrase('All Certifications') }}</h3>
                    </div>
                </div>
            </div>
    ...
    <!-------------- List Item Start   --------------->
    <div class="eNtery-item certifications">
        <div class="container">
            <div class="row">
